                ...
                {pageName !== "video" && (
                  ...
                  <div className="group flex items-center">
                    ...
                    <button
                      ...
                      className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-1-0 border-[#404040] rounded-r-3xl bg-black/[0.1] dark:bg-white/[0.15]"
                    >
                  ...
                  <div className="flex items-center">
                    <div className="hidden md:flex">
                        <div
                          className={`flex justify-center items-center h-10 w-10 rounded-full ${isOnline ? "hover:bg-[#34a0a4]/[0.7]" : "hover:bg-[#f2bad5]/[0.4]"}`}
                        >
                            {isOnline ? (
                    ...
                    <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
                        <Link to={"https://github.com/dongyunkim96"}>
                            <img
                              src=""
                              alt="dongyunkim96"
                            />
